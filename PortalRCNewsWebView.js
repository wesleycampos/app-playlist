...
export default function PortalRCNewsWebView({ navigation }) {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.titleContainer}>
            <MaterialIcons name="article" size={24} color="#0A2A54" />
            <Text style={styles.headerTitle}>Portal RC News</Text>
          </View>
        </View>

        {/* WebView */}
        <WebView
          source={{ uri: 'https://portalrc.com.br' }}
