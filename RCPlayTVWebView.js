...
export default function RCPlayTVWebView({ navigation }) {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.titleContainer}>
            <MaterialIcons name="tv" size={24} color="#0A2A54" />
            <Text style={styles.headerTitle}>RC Play TV</Text>
          </View>
        </View>

        {/* WebView */}
        <WebView
          source={{ uri: 'https://www.youtube.com/@rcplaytv' }}
